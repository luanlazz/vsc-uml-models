package com.vsc.demo.uml.reader;
...
import com.vsc.demo.uml.models._class.ClassRelation;
import com.vsc.demo.uml.models._class.ClassStructure;
import com.vsc.demo.uml.models._class.OperationParameter;
import com.vsc.demo.uml.models._class.OperationReturn;
import com.vsc.demo.utils.Keywords;
...
public class ClassStructureReader {
    ...
    public static ClassStructure readClass(Element element, String packageName) {
        ...
        for (Class superClass : _class.getSuperClasses()) {
            ...
            superClassStructure.setId(idSC);
